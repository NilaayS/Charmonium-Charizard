...
plt.tight_layout()
plt.savefig('C:/Users/Admin/Downloads/cornell.pdf', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('C:/Users/Admin/Downloads/spectrum.pdf', bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('C:/Users/Admin/Downloads/convergence.pdf', bbox_inches='tight')
plt.close()
